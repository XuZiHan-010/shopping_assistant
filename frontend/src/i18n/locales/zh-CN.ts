...
export const zhCN = {
  ...
  knowledgeBaseView: {
    ...
    renameDomain: '重命名业务域',
    deleteNode: '删除',
    loadingTree: '正在加载知识目录…',
    selectDocumentPrompt: '请选择一篇文档进行维护。',
    tokenVerificationFailed: '管理员令牌验证失败。',
    actionFailed: '操作失败，请重试。',
    deleteFailed: '删除失败，请重试。',
    createDocumentTitle: '新建文档',
    createDocumentLabel: '文档名称',
    createDocumentPlaceholder: '例如：订单履约口径.md',
    createDomainTitle: '新建业务域',
    createDomainLabel: '业务域名称',
    createDomainPlaceholder: '例如：客服',
    renameDomainTitle: '重命名业务域',
    renameDomainLabel: '业务域名称',
  },
  adminTokenDialog: {
    eyebrow: 'BOROUGH · KNOWLEDGE OPS',
    title: '知识库维护后台',
    instructions: '请输入管理员令牌后继续。',
    tokenLabel: '管理员令牌',
    viewerToggleLabel: '使用只读令牌浏览',
    submit: '进入后台',
  },
  confirmDeleteDialog: {
    title: '删除知识节点',
    domainWarning: '该业务域及其全部文档将被级联删除，此操作不可撤销。',
    documentWarning: '该文档将被删除，此操作不可撤销。',
    cancel: '取消',
    confirmPending: '删除中…',
    confirm: '确认删除',
  },
  ...
  knowledgeTree: {
    navAria: '知识库目录',
    title: '知识目录',
    createDomainLabel: '+ 业务域',
    createDomainAria: '新建业务域',
    readOnlyBadge: '只读',
  },
  documentEditor: {
    memoryReadOnlyBadge: '记忆只读',
    contentAria: '{path} 内容',
    save: '保存修改',
