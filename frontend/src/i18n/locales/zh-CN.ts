...
export const zhCN = {
  ...
  opsDashboardView: {
    ...
    title: 'Chat BI 运营看板',
    caption: '用可解释的汇总指标持续观察问答体验与质量。',
    signOut: '退出后台',
    controlsAria: '看板窗口与汇总操作',
    windowsAria: '统计窗口',
    windowLabel: '最近 {days} 天',
    refresh: '重刷汇总',
    refreshing: '正在重刷…',
    loading: '正在加载 Chat BI 数据…',
    tokenVerificationFailed: '管理员令牌验证失败。',
    refreshFailed: '重刷汇总失败，请稍后重试。',
  },
  northStarCards: {
    sectionAria: 'Chat BI 北极星指标',
    insufficientSample: '样本不足',
    secondsValue: '{value} 秒',
    adoptionLabel: '回复采纳率',
    adoptionHint: '商家点击采纳的回答占比',
    userAccuracyLabel: '用户侧准确率',
    userAccuracyHint: '点赞 /（点赞 + 点踩）',
    systemAccuracyLabel: '系统侧准确率',
    systemAccuracyHint: 'Reviewer 一次通过率',
    thinkingLabel: '平均思考时长',
    thinkingHint: '一轮问答从提问到成稿',
    hitLabel: '问题命中率',
    hitHint: '业务提问中命中数据或知识的占比',
    failureLabel: '回答失效率',
    failureHint: '降级或质量未通过的占比',
  },
  categoryTable: {
    eyebrow: '分类下钻',
    title: '按问题分类查看表现',
    ...
    colAnswerTotal: '问答量',
    colAdoption: '采纳率',
    colUserAccuracy: '用户侧准确率',
    colSystemAccuracy: '系统侧准确率',
    colThinking: '平均思考时长',
    colHit: '命中率',
    colFailure: '失效率',
    empty: '当前窗口暂无可下钻的分类数据。',
    insufficientSample: '样本不足',
    secondsValue: '{value} 秒',
  },
  trendChart: {
    ...
    axisRate: '比率',
    axisAnswers: '问答量',
    ariaDescription: '展示统计窗口内采纳率、命中率与问答量的每日趋势。',
  },
  errorCopy: {
    // —— 后端 ErrorCode（28 项） ——
    AUTH_REQUIRED: {
