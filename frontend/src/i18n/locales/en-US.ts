...
export const enUS = {
  ...
  opsDashboardView: {
    ...
    title: 'Chat BI operations dashboard',
    caption:
      'Keep a continuous, explainable view of Q&A experience and quality using summary metrics.',
    signOut: 'Sign out',
    controlsAria: 'Dashboard window and rollup actions',
    windowsAria: 'Statistics window',
    windowLabel: 'Last {days} days',
    refresh: 'Refresh rollup',
    refreshing: 'Refreshing…',
    loading: 'Loading Chat BI data…',
    tokenVerificationFailed: 'Admin token verification failed.',
    refreshFailed: 'Failed to refresh the rollup. Please try again later.',
  },
  northStarCards: {
    sectionAria: 'Chat BI north star metrics',
    insufficientSample: 'Insufficient sample',
    secondsValue: '{value} s',
    adoptionLabel: 'Adoption rate',
    adoptionHint: 'Share of answers merchants clicked to adopt',
    userAccuracyLabel: 'User-side accuracy',
    userAccuracyHint: 'Likes / (Likes + dislikes)',
    systemAccuracyLabel: 'System-side accuracy',
    systemAccuracyHint: 'Reviewer first-pass rate',
    thinkingLabel: 'Average thinking time',
    thinkingHint: 'From question to finished answer for one round',
    hitLabel: 'Question hit rate',
    hitHint: 'Share of business questions that hit data or knowledge',
    failureLabel: 'Answer failure rate',
    failureHint: 'Share of degraded or quality-failed answers',
  },
  categoryTable: {
    eyebrow: 'Category drill-down',
    title: 'Performance by question category',
    colCategory: 'Question category',
    colAnswerTotal: 'Answers',
    colAdoption: 'Adoption rate',
    colUserAccuracy: 'User-side accuracy',
    colSystemAccuracy: 'System-side accuracy',
    colThinking: 'Avg. thinking time',
    colHit: 'Hit rate',
    colFailure: 'Failure rate',
    empty: 'No category data to drill into for the current window.',
    insufficientSample: 'Insufficient sample',
    secondsValue: '{value} s',
  },
  trendChart: {
    eyebrow: 'Daily trend',
    title: 'Adoption rate, hit rate, and answer volume',
    canvasAria: 'Chat BI daily trend chart',
    empty: 'No daily trend data for the current window.',
    legendAdoption: 'Adoption rate',
    legendHit: 'Hit rate',
